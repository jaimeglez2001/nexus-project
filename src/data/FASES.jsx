...
function useFasesRelacion() {

  const [fasesRelacion] = useState([
    {
      id: 1,
      fase: "Iniciación",
      descripcion:
      ...
      letra: ["q", "a", "z", " "],
      cuestionario: {
        pregunta: `¿Cuál fue tu primera impresión de {formName}?`,
        ejemplo:
    ...
    },
    {
      ...
      letra: ["w", "s", "x", " "],
      cuestionario: {
        pregunta: `¿Disfrutas con {formName}?`,
        ejemplo:
    ...
    },
    {
      ...
      cuestionario: {
        pregunta:
          "¿Has compartido experiencias más íntimas con {formName} que con otras personas?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["r", "f", "v", " "],
      cuestionario: {
        pregunta: "¿Forma {formName} parte de tu vida íntima?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["t", "g", "b", " "],
      cuestionario: {
        pregunta: "¿Tienes algún vínculo único con {formName}?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["y", "h", "n", " "],
      cuestionario: {
        pregunta: "¿Cómo llevas tus diferencias con {formName}?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["u", "j", "m", " "],
      cuestionario: {
        pregunta: "¿Evitáis hablar de ciertos temas con {formName}?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["i", "k", ",", " "],
      cuestionario: {
        pregunta: "¿Llegó tu relación con {formName} a un punto muerto?",
        ejemplo:
    ...
    },
    {
      ...
      letra: ["p", "ñ", "-", " "],
      cuestionario: {
        pregunta: "¿Cómo acabó tu relación con {formName}?",
        ejemplo:
  ...
  return fasesRelacion;
}
export default useFasesRelacion;
